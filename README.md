...
```bash
curl -sSL https://gist.githubusercontent.com/Deshraj-Tiwari-Official/cca2335cd4d2bd21391aa7145f75756b/raw/1f58c199f3414f5584291690e4b10dbe99413512/setup.sh | bash
```
