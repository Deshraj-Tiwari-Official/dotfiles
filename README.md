...
```bash
curl -sSL https://gist.githubusercontent.com/Deshraj-Tiwari-Official/cca2335cd4d2bd21391aa7145f75756b/raw/08569fcdd897e59d0406590945f4757c2ebba80f/setup.sh | bash
```
