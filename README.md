...
```bash
curl -sSL https://gist.githubusercontent.com/Deshraj-Tiwari-Official/cca2335cd4d2bd21391aa7145f75756b/raw/e05c13c260d3e2dbbdd22ec8dbdb856e04843a67/setup.sh | bash
```
